...
function DataExporter({ technologies }) {
  ...
  const exportData = () => {
    ...
    setExportStatus('✅ Файл успешно экспортирован');
    ...
    <div className="data-exporter">
      ...
      <div className="export-options">
        ...
        <div className="form-group checkbox-group">
          <label htmlFor="include-data" className="checkbox-label">
            <input
              id="include-data"
              type="checkbox"
              checked={includeUserData}
              onChange={(e) => setIncludeUserData(e.target.checked)}
              aria-describedby="include-data-help"
            />
            <span>Включить мои заметки и прогресс</span>
          </label>
          <span id="include-data-help" className="help-text">
      ...
      {!canExport && (
        <div className="export-warning" role="alert" aria-live="polite">
